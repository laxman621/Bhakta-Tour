...
(async () => {
    ...
    data.forEach(item => {
        ...
        const redirect = `https://maneedasshrestha.github.io/Bhakta-Tour/edit_page.html?id=${item.id}`;
...
// https://maneedasshrestha.github.io/Bhakta-Tour/edit_page.html?id=38
